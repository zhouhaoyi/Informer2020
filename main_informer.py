...
parser.add_argument(
    ...
    default="h",
    help=(
        "freq for time features encoding, options:[s:secondly, t:minutely, "
        "h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also"
        " use more detailed freq like 15min or 3h"
    ),
)
parser.add_argument(
    "--checkpoints",
